...
import { DemoModal, type DemoType } from "../components/demos/DemoModal";
...
export function Projects() {
  ...
  const projects: {
  ...
  }[] = [
    {
      ...
      color: "blue",
      demoType: "id-verification" as DemoType,
      githubUrl: "https://github.com/mazharjahjah",
    },
    {
      icon: Database,
      ...
      color: "violet",
      demoType: "data-pipeline" as DemoType,
      githubUrl: "https://github.com/mazharjahjah",
    },
    {
      icon: Plane,
      ...
      color: "pink",
      demoType: "travel-recommender" as DemoType,
      githubUrl: "https://github.com/mazharjahjah",
    },
    {
      icon: Database,
